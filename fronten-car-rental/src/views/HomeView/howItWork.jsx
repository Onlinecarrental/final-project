...
const getImageUrl = (path) => {
  ...
  return `https://backendonlinecar.netlify.app/functions/express-server/uploads/homepage/${path}`;
};
  ...
  useEffect(() => {
    const fetchHowItWorks = async () => {
      try {
        ...
        const response = await axios.get('https://backendonlinecar.netlify.app/functions/express-server/api/homepage/howItWorks');
