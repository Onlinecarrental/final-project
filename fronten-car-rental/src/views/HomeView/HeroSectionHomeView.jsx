...
const getImageUrl = (path) => {
  ...
  return `https://backendonlinecar.netlify.app/functions/express-server/${path.replace(/^\/+/, '')}`;
};
  ...
  useEffect(() => {
    const fetchHeroData = async () => {
      try {
        ...
        const response = await axios.get('https://backendonlinecar.netlify.app/functions/express-server/api/homepage/hero');
