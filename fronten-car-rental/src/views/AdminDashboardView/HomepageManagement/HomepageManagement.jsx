...
export default function HomepageManagement({ section = 'hero' }) {
  ...
  const fetchSections = async () => {
    try {
      ...
      const response = await axios.get('https://backendonlinecar.netlify.app/functions/express-server/api/homepage');
  ...
  const getImageUrl = (imagePath) => {
    ...
    return imagePath.startsWith('http')
      ? imagePath
      : `https://backendonlinecar.netlify.app/functions/express-server${imagePath}`;
  };
