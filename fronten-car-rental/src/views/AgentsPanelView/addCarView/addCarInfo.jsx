      ...
      if (id) {
        try {
          ...
          if (response.data.success) {
            ...
            // Set image previews
            setImagePreviews({
              coverImage: `https://backendonlinecar.netlify.app/functions/express-server/${carData.coverImage}`,
              image1: carData.image1 ? `https://backendonlinecar.netlify.app/functions/express-server/${carData.image1}` : null,
              image2: carData.image2 ? `https://backendonlinecar.netlify.app/functions/express-server/${carData.image2}` : null,
              image3: carData.image3 ? `https://backendonlinecar.netlify.app/functions/express-server/${carData.image3}` : null,
              image4: carData.image4 ? `https://backendonlinecar.netlify.app/functions/express-server/${carData.image4}` : null
            });
          }
        } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios({
        ...
        url: isEditing ? `${import.meta.env.VITE_API_URL}/api/cars/${id}` : 'https://backendonlinecar.netlify.app/functions/express-server/api/cars',
        data: formDataToSend,
        headers: {
