...
export default function AddCarInfo() {
      ...
      if (id) {
        try {
          ...
          const response = await axios.get(
            `https://backend-car-rental-production.up.railway.app/api/cars/${id}`
          );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const API_BASE_URL =
        "https://backend-car-rental-production.up.railway.app/api";
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-7xl mx-auto">
      ...
      <div className="w-full mx-auto px-4 py-6">
        <h2 className="text-2xl font-bold mb-4 pb-2 border-b border-gray">
          Car Info
        </h2>
...
{/* Model Field */}
          ...
          {/* Year Field */}
          <div>
            <label htmlFor="year" className="block text-lg font-medium mb-1">
              Year
            </label>
            <input
              type="text"
          ...
          {/* Color Field */}
          <div>
            <label htmlFor="color" className="block text-lg font-medium mb-1">
              Color:
            </label>
            <input
              type="text"
          ...
          {/* Seats Field */}
          <div>
            <label htmlFor="seats" className="block text-lg font-medium mb-1">
              Seats
            </label>
            <input
              type="number"
      ...
      <div className="w-full mx-auto px-4 py-6">
        <h2 className="text-3xl font-bold mb-4 pb-2 border-b border-gray-300">
          Features & Pricing
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
          {/* Categories Field */}
      ...
      <div className="w-full mx-auto px-4 py-6">
        <h2 className="text-3xl font-bold mb-4 border-b border-gray">
          Features
        </h2>
          ...
          <div className="space-y-6">
            ...
            {["ac", "automatic", "manual"].map((feature) => (
              <div key={feature} className="flex items-center">
                ...
                <label
                  className="ml-3 text-xl cursor-pointer capitalize"
                  onClick={() => handleFeatureChange(feature)}
                >
