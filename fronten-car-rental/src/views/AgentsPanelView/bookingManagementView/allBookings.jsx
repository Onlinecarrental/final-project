...
export default function AllBookings() {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        ...
        const res = await axios.get(`https://backend-car-rental-production.up.railway.app/api/bookings/agent/${user.uid}`);
  ...
  const handleApprove = async (bookingId) => {
    try {
      await axios.patch(`https://backend-car-rental-production.up.railway.app/api/bookings/${bookingId}/approve`);
  ...
  const handleReject = async (bookingId) => {
    try {
      await axios.patch(`https://backend-car-rental-production.up.railway.app/api/bookings/${bookingId}/reject`);
  ...
  const handleApprovalSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`https://backend-car-rental-production.up.railway.app/api/payments/booking/${selectedBooking._id}/approve-with-bank-details`, approvalForm);
