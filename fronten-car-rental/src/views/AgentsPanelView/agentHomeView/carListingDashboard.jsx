...
const CarListingDashboard = () => {
  ...
  const fetchCars = async () => {
    try {
      ...
      setError("");
      if (!user.uid) return;
      const res = await axios.get('https://backendonlinecar.netlify.app/functions/express-server/api/cars');
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="w-10 h-10 rounded-md overflow-hidden bg-white">
                  <img
                    src={`https://backendonlinecar.netlify.app/functions/express-server/${car.coverImage}`}
                    alt={car.name}
