...
function PaymentForm({ booking, onPaymentSuccess, onPaymentError }) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const paymentIntentResponse = await axios.post('https://backendonlinecar.netlify.app/functions/express-server/api/payments/create-payment-intent', {
            ...
            if (paymentIntent.status === 'succeeded') {
                ...
                await axios.post('https://backendonlinecar.netlify.app/functions/express-server/api/payments/confirm-payment', {
                    paymentIntentId,
                    paymentId
                });
    ...
    const handlePaymentSuccess = async (bookingId) => {
        ...
        try {
            ...
            if (booking && booking.agent) {
                ...
                const chatRes = await axios.post('https://backendonlinecar.netlify.app/functions/express-server/api/chats', { userId, agentId });
                ...
                await axios.post('https://backendonlinecar.netlify.app/functions/express-server/api/chats/messages', {
                    chatId,
                    senderId: userId,
                    senderRole: 'customer',
                    text: paymentMsg
