...
export default function BookingForm() {
  ...
  const createChatWithAgent = async () => {
    try {
      ...
      // Create chat
      const chatResponse = await axios.post('/.netlify/functions/api/api/chats', { userId, agentId });
      ...
      await axios.post('/.netlify/functions/api/api/chats/messages', messageData);
  ...
  const handleSubmit = async () => {
    if (validateStep()) {
      ...
      try {
        ...
        await axios.post('/.netlify/functions/api/api/bookings', bookingPayload);
