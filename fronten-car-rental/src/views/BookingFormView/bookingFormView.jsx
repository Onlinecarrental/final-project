...
export default function BookingForm() {
  ...
  const createChatWithAgent = async () => {
    try {
      ...
      // Create chat
      const chatResponse = await axios.post('https://backendonlinecar.netlify.app/functions/express-server/api/chats', { userId, agentId });
      ...
      await axios.post('https://backendonlinecar.netlify.app/functions/express-server/api/chats/messages', messageData);
  ...
  const handleSubmit = async () => {
    if (validateStep()) {
      ...
      try {
        ...
        await axios.post('https://backendonlinecar.netlify.app/functions/express-server/api/bookings', bookingPayload);
