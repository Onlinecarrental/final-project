  ...
  useEffect(() => {
    const fetchTrustData = async () => {
      try {
        ...
        const response = await axios.get(`${API_BASE_URL}/about/trust?timestamp=${timestamp}`, {
          headers: {
    ...
    <div className="flex flex-col md:flex-row gap-10 mt-8 justify-between items-start p-6 bg-white max-w-6xl mx-auto">
      ...
      <div className="w-full md:w-1/2 mt-6 md:mt-0">
        <div className="rounded-lg overflow-hidden">
          <img
            src={imagePath ? (imagePath.startsWith('http') ? imagePath : `/.netlify/functions/api/${imagePath}`) : "../src/assets/AUcar.svg"}
            alt="Luxury car"
